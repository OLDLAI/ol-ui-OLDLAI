...
hoistedDependencies:
  ...
  /next-tick/1.1.0:
    next-tick: private
  /nimble-lib/0.0.15(axios@0.18.1)(fetch-jsonp@1.2.3)(jszip-utils@0.0.2)(jszip@3.10.1)(lottie-web@5.10.2)(rxjs@5.5.12)(swiper@4.5.1):
    nimble-lib: private
  ...
  /ol-ui/1.0.12(axios@0.18.1)(fetch-jsonp@1.2.3)(jszip-utils@0.0.2)(jszip@3.10.1)(lottie-web@5.10.2)(rxjs@5.5.12)(swiper@4.5.1):
    ol-ui: private
  /once/1.4.0:
    once: private
  /onetime/6.0.0:
  ...
  /vite-node/0.29.8(@types/node@18.15.0)(less@4.1.3):
    vite-node: private
  /vitepress/1.0.0-alpha.50(@algolia/client-search@4.15.0)(@types/node@18.15.0)(less@4.1.3):
    vitepress: private
  /vm2/3.9.14:
    vm2: private
...
pendingBuilds:
  ...
  - /@esbuild/win32-x64/0.16.17
  - /source-map/0.6.1
prunedAt: Wed, 12 Apr 2023 15:40:10 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
