import { defineComponent as v, reactive as L, ref as j, computed as l, unref as i, onUpdated as E, watchEffect as R, openBlock as m, createElementBlock as d, normalizeClass as $, normalizeStyle as g, createElementVNode as b, Fragment as k, renderList as B, renderSlot as N } from "vue";
    ...
    return E(() => {
      ...
      b("div", {
        ...
        b("div", {
          ...
          (m(!0), d(k, null, B(i(y), (r, c) => (m(), d("div", {
            key: c + t.start
          }, [
            N(e.$slots, "default", { item: r }, void 0, !0)
          ]))), 128))
        ], 4)
      ], 4)
    ], 38));
